...
const Button = (props: Props & MotionProps) => {
  ...
  const classes = `${
    ...
    center ? 'mx-auto' : ''
  } w-fit font-mono capitalize rounded border-amber-900 text-amber-900 hover:bg-amber-light focus:outline-none focus:bg-amber-light duration-150 cursor-pointer ${className}`;
